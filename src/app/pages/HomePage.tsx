    ...
    <div className="w-full bg-[#EFE9E1] text-[#322D29] selection:bg-[#72383D] selection:text-[#EFE9E1] overflow-x-hidden">
      ...
      <FadeIn>
        <section className="relative w-full h-[75vh] md:h-[70vh] overflow-hidden bg-[#322D29]">
          ...
          {/* Slider Indicators */}
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-24 flex gap-3 z-20">
            {heroBanners.map((_, i) => (
              <button 
                key={i} 
                ...
                <FadeIn key={i} delay={i * 150}>
                  <Link to="/shop" className="block relative aspect-[4/5] md:aspect-[3/4] group overflow-hidden border border-[#D1C7BD]">
                    ...
                    <div className="absolute bottom-4 md:bottom-6 left-0 right-0 text-center px-2">
                      <h3 className="text-lg md:text-2xl font-serif text-[#EFE9E1] tracking-widest">{cat.name}</h3>
                      <span className="text-[10px] md:text-xs text-[#D1C7BD] uppercase tracking-widest mt-1.5 md:mt-2 inline-flex items-center opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform md:translate-y-2 group-hover:translate-y-0">
        ...
        <FadeIn>
          ...
          {loadingProducts ? (
            ...
            <div className="flex overflow-x-auto md:grid md:grid-cols-4 gap-4 md:gap-6 pb-6 -mx-4 px-4 md:mx-0 md:px-0 md:pb-0 snap-x snap-mandatory [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
              {blends.map((p, i) => (
                <div key={p.id} className="w-[80vw] sm:w-[45vw] md:w-auto flex-shrink-0 snap-start">
                  <FadeIn delay={i * 100}><ProductCard product={p} /></FadeIn>
                </div>
              ))}
            </div>
          )}
      ...
      <section className="w-full">
        <FadeIn>
          <div className="relative w-full h-[40vh] md:h-[50vh] bg-[#322D29] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4">
              <Star className="w-6 h-6 md:w-8 md:h-8 text-[#72383D] mx-auto mb-4 md:mb-6" />
              <h2 className="text-2xl md:text-5xl font-serif text-[#EFE9E1] mb-5 md:mb-6 uppercase tracking-[0.15em] md:tracking-[0.2em] max-w-3xl leading-snug">
                Crafted for a <br/><span className="text-[#D1C7BD]">Luxurious Experience</span>
              </h2>
              <Link to="/shop" className="inline-block border border-[#D1C7BD] text-[#EFE9E1] px-8 py-2.5 md:px-10 md:py-3 text-xs md:text-sm uppercase tracking-widest hover:bg-[#72383D] hover:border-[#72383D] transition-colors">
                Shop The Collection
              </Link>
            </div>
          </div>
          ...
          <div className="bg-[#1A1816] py-8 border-t border-[#322D29]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4 text-center text-[#D1C7BD]">
                <div className="flex flex-col items-center justify-center">
                  <ShieldCheck className="w-5 h-5 md:w-6 md:h-6 mb-2 md:mb-3 text-[#AC9C8D]" />
                  <span className="text-[10px] md:text-xs uppercase tracking-widest font-medium">Premium Quality</span>
                </div>
                <div className="flex flex-col items-center justify-center">
                  <Droplets className="w-5 h-5 md:w-6 md:h-6 mb-2 md:mb-3 text-[#AC9C8D]" />
                  <span className="text-[10px] md:text-xs uppercase tracking-widest font-medium">Long Lasting</span>
                </div>
                <div className="flex flex-col items-center justify-center">
                  <Leaf className="w-5 h-5 md:w-6 md:h-6 mb-2 md:mb-3 text-[#AC9C8D]" />
                  <span className="text-[10px] md:text-xs uppercase tracking-widest font-medium">Cruelty Free</span>
                </div>
                <div className="flex flex-col items-center justify-center">
                  <Star className="w-5 h-5 md:w-6 md:h-6 mb-2 md:mb-3 text-[#AC9C8D]" />
                  <span className="text-[10px] md:text-xs uppercase tracking-widest font-medium">Crafted in France</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-[#EFE9E1] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
              <div className="w-full lg:w-1/2 relative group px-2 md:px-0">
                <div className="absolute inset-0 bg-[#D1C7BD] translate-x-2 translate-y-2 md:translate-x-4 md:translate-y-4 group-hover:translate-x-1 group-hover:translate-y-1 md:group-hover:translate-x-2 md:group-hover:translate-y-2 transition-transform duration-500"></div>
              ...
              <div className="w-full lg:w-1/2">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-[#322D29] leading-tight mb-4 md:mb-6 text-center md:text-left">
                  Why settle for ordinary, when you can experience <span className="text-[#72383D] italic">extraordinary</span>?
                </h2>
                <p className="text-[#AC9C8D] text-base md:text-lg font-light mb-8 md:mb-10 leading-relaxed text-center md:text-left">
                ...
                <ul className="space-y-4 md:space-y-6 text-[#322D29] font-medium text-sm md:text-base px-2 md:px-0">
                  <li className="flex items-center"><CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-[#72383D] mr-3 md:mr-4 shrink-0" /> 25% High Perfume Concentration</li>
                  <li className="flex items-center"><CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-[#72383D] mr-3 md:mr-4 shrink-0" /> Macerated for 60 Days</li>
                  <li className="flex items-center"><CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-[#72383D] mr-3 md:mr-4 shrink-0" /> Phthalate & Paraben Free</li>
                </ul>
              </div>
            </div>
          </FadeIn>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-1 relative group overflow-hidden border border-[#D1C7BD] h-[300px] md:min-h-[400px]">
                ...
                <div className="absolute bottom-6 left-6">
                  ...
                  <Link to="/shop?category=men" className="text-[10px] md:text-xs text-[#D1C7BD] uppercase tracking-widest border-b border-[#D1C7BD] pb-1 hover:text-[#EFE9E1]">
                    Shop Men
                  </Link>
                </div>
              </div>
          ...
          <FadeIn>
            ...
            {loadingProducts ? (
              ...
              <div className="flex overflow-x-auto md:grid md:grid-cols-4 gap-4 md:gap-6 pb-6 -mx-4 px-4 md:mx-0 md:px-0 md:pb-0 snap-x snap-mandatory [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                {gifting.map((p, i) => (
                  <div key={p.id} className="w-[80vw] sm:w-[45vw] md:w-auto flex-shrink-0 snap-start">
                    <FadeIn delay={i * 100}><ProductCard product={p} badge="Gift Set" /></FadeIn>
                  </div>
                ))}
              </div>
            )}
...
function InstagramReelsSection() {
  const reels = [
    { id: 1, thumbnail: "https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&q=80&w=600", views: "124K", handle: "@perfume.junkie" },
    { id: 2, thumbnail: "https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&q=80&w=600", views: "89K", handle: "@luxe.scents" },
    { id: 3, thumbnail: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&q=80&w=600", views: "210K", handle: "@style.by.marc" },
    { id: 4, thumbnail: "https://images.unsplash.com/photo-1615634260167-c8cdede054de?auto=format&fit=crop&q=80&w=600", views: "150K", handle: "@fragrance.daily" }
  ];

  return (
    <section className="py-16 md:py-24 bg-[#322D29]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl md:text-4xl font-serif text-[#EFE9E1] tracking-wide mb-3 md:mb-4">
              Loved By The Community
            </h2>
            <p className="text-[#AC9C8D] text-[10px] md:text-sm uppercase tracking-widest font-medium">
              Join the conversation on Instagram
            </p>
            <div className="w-12 md:w-16 h-px bg-[#72383D] mx-auto mt-4 md:mt-6"></div>
          </div>
              ...
              <FadeIn key={reel.id} delay={i * 150}>
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-black/40 transition-colors duration-300">
                    <div className="bg-white/20 backdrop-blur-sm p-3 md:p-4 rounded-full text-white group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4 right-3 md:right-4 flex justify-between items-end text-[#EFE9E1]">
                    <span className="text-[10px] md:text-xs font-medium tracking-wide">{reel.handle}</span>
                    <span className="text-[10px] md:text-xs font-semibold flex items-center text-[#D1C7BD]">
                      <Play className="w-2.5 h-2.5 md:w-3 md:h-3 mr-1" /> {reel.views}
                    </span>
                  </div>
                </a>
              </FadeIn>
...
function SectionHeader({ title, link }: { title: string, link?: string }) {
  return (
    <div className="relative flex flex-col items-center justify-center mb-8 md:mb-12">
      <h2 className="text-2xl md:text-4xl font-serif text-[#322D29] tracking-wide text-center">{title}</h2>
      <div className="w-12 md:w-16 h-px bg-[#72383D] mt-3 md:mt-4 mb-2"></div>
      {link && (
        <Link 
          to={link} 
          className="mt-3 md:mt-0 md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#322D29] border border-[#AC9C8D] px-5 py-2.5 hover:bg-[#322D29] hover:text-[#EFE9E1] hover:border-[#322D29] transition-all"
        >
          View All
        </Link>
      )}
